            ...
            <div class="main-content-container container-fluid px-4">
                ...
                <div class="page-header row no-gutters py-4">
                    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                        ...
                        <h3 class="page-title"><?=$lang["index"]["h1"]?></h3>
                    </div>
                </div>
                <!-- End Page Header -->
                <!-- Small Stats Blocks -->
                            ...
                            <div class="card-body p-0 d-flex">
                                <div class="d-flex flex-column m-auto">
                                    <div class="stats-small__data text-center">
                                        <span class="stats-small__label text-uppercase"><?=$lang["index"]["card_1"]?></span>
                                        <h6 class="stats-small__value count my-3">370</h6>
                                    </div>
                    ...
                    <div class="col-lg col-md-6 col-sm-6 mb-4">
                        <div class="stats-small stats-small--1 card card-small">
                            <div class="card-body p-0 d-flex">
                                <div class="d-flex flex-column m-auto">
                                    <div class="stats-small__data text-center">
                                        <span class="stats-small__label text-uppercase"><?=$lang["index"]["card_2"]?></span>
                                        <h6 class="stats-small__value count my-3">67</h6>
                                    </div>
                                    <div class="stats-small__data">
                    ...
                    <div class="col-lg col-md-4 col-sm-6 mb-4">
                        <div class="stats-small stats-small--1 card card-small">
                            <div class="card-body p-0 d-flex">
                                <div class="d-flex flex-column m-auto">
                                    <div class="stats-small__data text-center">
                                        <span class="stats-small__label text-uppercase"><?=$lang["index"]["card_3"]?></span>
                                        <h6 class="stats-small__value count my-3">71</h6>
                                    </div>
                                    <div class="stats-small__data">
                    ...
                    <div class="col-lg col-md-4 col-sm-6 mb-4">
                        <div class="stats-small stats-small--1 card card-small">
                            <div class="card-body p-0 d-flex">
                                <div class="d-flex flex-column m-auto">
                                    <div class="stats-small__data text-center">
                                        <span class="stats-small__label text-uppercase"><?=$lang["index"]["card_4"]?></span>
                                        <h6 class="stats-small__value count my-3">32</h6>
                                    </div>
                                    <div class="stats-small__data">
                                        <span class="stats-small__percentage stats-small__percentage--increase">12.4%</span>
                                    </div>
                    ...
                    <div class="col-lg col-md-4 col-sm-12 mb-4">
                        <div class="stats-small stats-small--1 card card-small">
                            <div class="card-body p-0 d-flex">
                                <div class="d-flex flex-column m-auto">
                                    <div class="stats-small__data text-center">
                                        <span class="stats-small__label text-uppercase"><?=$lang["index"]["card_5"]?></span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 mb-4">
                        <div class="card card-small">
                            <div class="card-header border-bottom">
                                <h6 class="m-0"><?=$lang["index"]["info"]?></h6>
                            </div>
                            <div class="card-body pt-0">
                                <br>
                                <?=$lang["index"]["info_text"]?>
                                <br><br>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="card card-small h-100">
                            <div class="card-header border-bottom">
                                <h6 class="m-0">Основні напрямки</h6>
                            </div>
