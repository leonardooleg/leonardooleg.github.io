              ...
              <div class="col-lg-5">
                <div class="card card-small mb-4 pt-3">
                  <div class="card-header border-bottom text-center">
                    ...
                    <h4 class="mb-0"><?=$lang["i"]?></h4>
                    <span class="text-muted d-block mb-2"><?=$lang["i2"]?></span>
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item px-4">
                      <div class="progress-wrapper">
                        <strong class="text-muted d-block mb-2"><?=$lang["Workload"]?></strong>
                    ...
                    <li class="list-group-item p-4">
                      <strong class="text-muted d-block mb-2">Про мене </strong>
                      <span> <?=$lang["index"]["info_text"]?></span>
                    </li>
                  </ul>
                </div>
              </div>
